...
Result<UdpMessageCbor*> UdpMessageCbor::from_poly(const Poly& value) {
    auto msg = std::make_unique<UdpMessageCbor>();
    if (!value.is_object()) {
...
Result<AliveEvent*> AliveEvent::from_poly(const Poly& value) {
    auto msg = std::make_unique<AliveEvent>();
    if (!value.is_object()) {
...
Result<LogEvent*> LogEvent::from_poly(const Poly& value) {
    auto msg = std::make_unique<LogEvent>();
    if (!value.is_object()) {
...
Result<Poly> SysRequest::to_poly(const SysRequest& msg) {
    Poly obj = Poly::object();
    if (msg.req_id)obj["req_id"] = *msg.req_id;
...
Result<SysRequest*> SysRequest::from_poly(const Poly& value) {
    auto msg = std::make_unique<SysRequest>();
    if (!value.is_object()) {
        return Result<SysRequest*>::Err(-1, "Expected Poly object");
    }
    
            if (value["req_id"].is_number()) {
                if (value["req_id"].is_signed()) {
                    msg->req_id = static_cast<uint32_t>(value["req_id"].as_int64());
                } else if (value["req_id"].is_unsigned()) {
                    msg->req_id = static_cast<uint32_t>(value["req_id"].as_uint64());
                }
            }
...
Result<Bytes> SysRequest::json_serialize(const SysRequest& msg)  {
        JsonDocument doc;
        doc.to<JsonObject>();
        if (msg.req_id)doc["req_id"] = *msg.req_id;
    ...
    Result<SysRequest*> SysRequest::json_deserialize(const Bytes& bytes) {
        ...
        if (doc["req_id"].is<uint32_t>() )  
                        msg->req_id = doc["req_id"].as<uint32_t>();
...
Result<SysReply*> SysReply::from_poly(const Poly& value) {
    auto msg = std::make_unique<SysReply>();
    if (!value.is_object()) {
...
Result<SysEvent*> SysEvent::from_poly(const Poly& value) {
    auto msg = std::make_unique<SysEvent>();
    if (!value.is_object()) {
...
Result<WifiEvent*> WifiEvent::from_poly(const Poly& value) {
    auto msg = std::make_unique<WifiEvent>();
    if (!value.is_object()) {
...
Result<MulticastEvent*> MulticastEvent::from_poly(const Poly& value) {
    auto msg = std::make_unique<MulticastEvent>();
    if (!value.is_object()) {
...
Result<PingReply*> PingReply::from_poly(const Poly& value) {
    auto msg = std::make_unique<PingReply>();
    if (!value.is_object()) {
...
Result<HoverboardEventRaw*> HoverboardEventRaw::from_poly(const Poly& value) {
    auto msg = std::make_unique<HoverboardEventRaw>();
    if (!value.is_object()) {
...
Result<HoverboardEvent*> HoverboardEvent::from_poly(const Poly& value) {
    auto msg = std::make_unique<HoverboardEvent>();
    if (!value.is_object()) {
...
Result<HoverboardRequest*> HoverboardRequest::from_poly(const Poly& value) {
    auto msg = std::make_unique<HoverboardRequest>();
    if (!value.is_object()) {
...
Result<HoverboardReply*> HoverboardReply::from_poly(const Poly& value) {
    auto msg = std::make_unique<HoverboardReply>();
    if (!value.is_object()) {
...
Result<TouchPoint*> TouchPoint::from_poly(const Poly& value) {
    auto msg = std::make_unique<TouchPoint>();
    if (!value.is_object()) {
...
Result<Ps4Event*> Ps4Event::from_poly(const Poly& value) {
    auto msg = std::make_unique<Ps4Event>();
    if (!value.is_object()) {
...
Result<Ps4Request*> Ps4Request::from_poly(const Poly& value) {
    auto msg = std::make_unique<Ps4Request>();
    if (!value.is_object()) {
...
Result<CameraEvent*> CameraEvent::from_poly(const Poly& value) {
    auto msg = std::make_unique<CameraEvent>();
    if (!value.is_object()) {
...
Result<CameraRequest*> CameraRequest::from_poly(const Poly& value) {
    auto msg = std::make_unique<CameraRequest>();
    if (!value.is_object()) {
...
Result<CameraReply*> CameraReply::from_poly(const Poly& value) {
    auto msg = std::make_unique<CameraReply>();
    if (!value.is_object()) {
...
Result<LawnmowerManualEvent*> LawnmowerManualEvent::from_poly(const Poly& value) {
    auto msg = std::make_unique<LawnmowerManualEvent>();
    if (!value.is_object()) {
...
Result<LawnmowerManualRequest*> LawnmowerManualRequest::from_poly(const Poly& value) {
    auto msg = std::make_unique<LawnmowerManualRequest>();
    if (!value.is_object()) {
...
Result<LawnmowerManualReply*> LawnmowerManualReply::from_poly(const Poly& value) {
    auto msg = std::make_unique<LawnmowerManualReply>();
    if (!value.is_object()) {
...
Result<LawnmowerAutoEvent*> LawnmowerAutoEvent::from_poly(const Poly& value) {
    auto msg = std::make_unique<LawnmowerAutoEvent>();
    if (!value.is_object()) {
...
Result<LawnmowerAutoRequest*> LawnmowerAutoRequest::from_poly(const Poly& value) {
    auto msg = std::make_unique<LawnmowerAutoRequest>();
    if (!value.is_object()) {
...
Result<LawnmowerStatus*> LawnmowerStatus::from_poly(const Poly& value) {
    auto msg = std::make_unique<LawnmowerStatus>();
    if (!value.is_object()) {
...
Result<MotorEvent*> MotorEvent::from_poly(const Poly& value) {
    auto msg = std::make_unique<MotorEvent>();
    if (!value.is_object()) {
...
Result<Max31855Event*> Max31855Event::from_poly(const Poly& value) {
    auto msg = std::make_unique<Max31855Event>();
    if (!value.is_object()) {
...
Result<HeatingRequest*> HeatingRequest::from_poly(const Poly& value) {
    auto msg = std::make_unique<HeatingRequest>();
    if (!value.is_object()) {
...
Result<HeatingEvent*> HeatingEvent::from_poly(const Poly& value) {
    auto msg = std::make_unique<HeatingEvent>();
    if (!value.is_object()) {
...
Result<Bytes> SysRequest::cbor_serialize(const SysRequest& msg)  {
    ...
    if (msg.req_id) {
            RC_OK(cbor_encode_int(&mapEncoder, SysRequest::Field::REQ_ID_INDEX));
            RC_OK(cbor_encode_int(&mapEncoder, msg.req_id.value()));
            }
            // field: req_id
    if (msg.set_time) {
 ...
 Result<SysRequest*> SysRequest::cbor_deserialize(const Bytes& bytes) {
    ...
    while (!cbor_value_at_end(&mapIt)) {
        ...
        switch (key) {
            ...
            case SysRequest::Field::REQ_ID_INDEX:{{
    uint64_t v;
    cbor_value_get_uint64(&mapIt, &(v));
    msg->req_id = v;
};
...
Result<Bytes> SysReply::cbor_serialize(const SysReply& msg)  {
    ...
    if (msg.req_id) {
            RC_OK(cbor_encode_int(&mapEncoder, SysReply::Field::REQ_ID_INDEX));
            RC_OK(cbor_encode_int(&mapEncoder, msg.req_id.value()));
            }
            // field: req_id
    if (msg.rc) {
 ...
 Result<SysReply*> SysReply::cbor_deserialize(const Bytes& bytes) {
    ...
    while (!cbor_value_at_end(&mapIt)) {
        ...
        switch (key) {
            ...
            case SysReply::Field::REQ_ID_INDEX:{{
    uint64_t v;
    cbor_value_get_uint64(&mapIt, &(v));
    msg->req_id = v;
};
...
Result<Bytes> PingRequest::cbor_serialize(const PingRequest& msg)  {
    ...
    if (msg.req_id) {
            RC_OK(cbor_encode_int(&mapEncoder, PingRequest::Field::REQ_ID_INDEX));
            RC_OK(cbor_encode_int(&mapEncoder, msg.req_id.value()));
            }
            // field: req_id
    if (msg.number) {
 ...
 Result<PingRequest*> PingRequest::cbor_deserialize(const Bytes& bytes) {
    ...
    while (!cbor_value_at_end(&mapIt)) {
        ...
        switch (key) {
            ...
            case PingRequest::Field::REQ_ID_INDEX:{{
    uint64_t v;
    cbor_value_get_uint64(&mapIt, &(v));
    msg->req_id = v;
};
...
Result<Bytes> PingReply::cbor_serialize(const PingReply& msg)  {
    ...
    if (msg.req_id) {
            RC_OK(cbor_encode_int(&mapEncoder, PingReply::Field::REQ_ID_INDEX));
            RC_OK(cbor_encode_int(&mapEncoder, msg.req_id.value()));
            }
            // field: req_id
    if (msg.number) {
 ...
 Result<PingReply*> PingReply::cbor_deserialize(const Bytes& bytes) {
    ...
    while (!cbor_value_at_end(&mapIt)) {
        ...
        switch (key) {
            ...
            case PingReply::Field::REQ_ID_INDEX:{{
    uint64_t v;
    cbor_value_get_uint64(&mapIt, &(v));
    msg->req_id = v;
};
...
Result<Bytes> HoverboardRequest::cbor_serialize(const HoverboardRequest& msg)  {
    ...
    if (msg.req_id) {
            RC_OK(cbor_encode_int(&mapEncoder, HoverboardRequest::Field::REQ_ID_INDEX));
            RC_OK(cbor_encode_int(&mapEncoder, msg.req_id.value()));
            }
            // field: req_id
    if (msg.speed) {
 ...
 Result<HoverboardRequest*> HoverboardRequest::cbor_deserialize(const Bytes& bytes) {
    ...
    while (!cbor_value_at_end(&mapIt)) {
        ...
        switch (key) {
            ...
            case HoverboardRequest::Field::REQ_ID_INDEX:{{
    uint64_t v;
    cbor_value_get_uint64(&mapIt, &(v));
    msg->req_id = v;
};
...
Result<Bytes> HoverboardReply::cbor_serialize(const HoverboardReply& msg)  {
    ...
    if (msg.req_id) {
            RC_OK(cbor_encode_int(&mapEncoder, HoverboardReply::Field::REQ_ID_INDEX));
            RC_OK(cbor_encode_int(&mapEncoder, msg.req_id.value()));
            }
            // field: req_id
    if (msg.error_code) {
 ...
 Result<HoverboardReply*> HoverboardReply::cbor_deserialize(const Bytes& bytes) {
    ...
    while (!cbor_value_at_end(&mapIt)) {
        ...
        switch (key) {
            ...
            case HoverboardReply::Field::REQ_ID_INDEX:{{
    uint64_t v;
    cbor_value_get_uint64(&mapIt, &(v));
    msg->req_id = v;
};
...
Result<Bytes> Ps4Request::cbor_serialize(const Ps4Request& msg)  {
    ...
    if (msg.req_id) {
            RC_OK(cbor_encode_int(&mapEncoder, Ps4Request::Field::REQ_ID_INDEX));
            RC_OK(cbor_encode_int(&mapEncoder, msg.req_id.value()));
            }
            // field: req_id
    if (msg.rumble_small) {
 ...
 Result<Ps4Request*> Ps4Request::cbor_deserialize(const Bytes& bytes) {
    ...
    while (!cbor_value_at_end(&mapIt)) {
        ...
        switch (key) {
            ...
            case Ps4Request::Field::REQ_ID_INDEX:{{
    uint64_t v;
    cbor_value_get_uint64(&mapIt, &(v));
    msg->req_id = v;
};
...
Result<Bytes> CameraRequest::cbor_serialize(const CameraRequest& msg)  {
    ...
    if (msg.req_id) {
            RC_OK(cbor_encode_int(&mapEncoder, CameraRequest::Field::REQ_ID_INDEX));
            RC_OK(cbor_encode_int(&mapEncoder, msg.req_id.value()));
            }
            // field: req_id
    if (msg.led) {
 ...
 Result<CameraRequest*> CameraRequest::cbor_deserialize(const Bytes& bytes) {
    ...
    while (!cbor_value_at_end(&mapIt)) {
        ...
        switch (key) {
            ...
            case CameraRequest::Field::REQ_ID_INDEX:{{
    uint64_t v;
    cbor_value_get_uint64(&mapIt, &(v));
    msg->req_id = v;
};
...
Result<Bytes> CameraReply::cbor_serialize(const CameraReply& msg)  {
    ...
    if (msg.req_id) {
            RC_OK(cbor_encode_int(&mapEncoder, CameraReply::Field::REQ_ID_INDEX));
            RC_OK(cbor_encode_int(&mapEncoder, msg.req_id.value()));
            }
            // field: req_id
    if (msg.error_code) {
 ...
 Result<CameraReply*> CameraReply::cbor_deserialize(const Bytes& bytes) {
    ...
    while (!cbor_value_at_end(&mapIt)) {
        ...
        switch (key) {
            ...
            case CameraReply::Field::REQ_ID_INDEX:{{
    uint64_t v;
    cbor_value_get_uint64(&mapIt, &(v));
    msg->req_id = v;
};
...
Result<Bytes> LawnmowerManualRequest::cbor_serialize(const LawnmowerManualRequest& msg)  {
    ...
    if (msg.req_id) {
            RC_OK(cbor_encode_int(&mapEncoder, LawnmowerManualRequest::Field::REQ_ID_INDEX));
            RC_OK(cbor_encode_int(&mapEncoder, msg.req_id.value()));
            }
            // field: req_id
    if (msg.speed) {
 ...
 Result<LawnmowerManualRequest*> LawnmowerManualRequest::cbor_deserialize(const Bytes& bytes) {
    ...
    while (!cbor_value_at_end(&mapIt)) {
        ...
        switch (key) {
            ...
            case LawnmowerManualRequest::Field::REQ_ID_INDEX:{{
    uint64_t v;
    cbor_value_get_uint64(&mapIt, &(v));
    msg->req_id = v;
};
...
Result<Bytes> LawnmowerManualReply::cbor_serialize(const LawnmowerManualReply& msg)  {
    ...
    if (msg.req_id) {
            RC_OK(cbor_encode_int(&mapEncoder, LawnmowerManualReply::Field::REQ_ID_INDEX));
            RC_OK(cbor_encode_int(&mapEncoder, msg.req_id.value()));
            }
            // field: req_id
    if (msg.error_code) {
 ...
 Result<LawnmowerManualReply*> LawnmowerManualReply::cbor_deserialize(const Bytes& bytes) {
    ...
    while (!cbor_value_at_end(&mapIt)) {
        ...
        switch (key) {
            ...
            case LawnmowerManualReply::Field::REQ_ID_INDEX:{{
    uint64_t v;
    cbor_value_get_uint64(&mapIt, &(v));
    msg->req_id = v;
};
...
Result<Bytes> LawnmowerAutoRequest::cbor_serialize(const LawnmowerAutoRequest& msg)  {
    ...
    if (msg.req_id) {
            RC_OK(cbor_encode_int(&mapEncoder, LawnmowerAutoRequest::Field::REQ_ID_INDEX));
            RC_OK(cbor_encode_int(&mapEncoder, msg.req_id.value()));
            }
            // field: req_id
    if (msg.start) {
 ...
 Result<LawnmowerAutoRequest*> LawnmowerAutoRequest::cbor_deserialize(const Bytes& bytes) {
    ...
    while (!cbor_value_at_end(&mapIt)) {
        ...
        switch (key) {
            ...
            case LawnmowerAutoRequest::Field::REQ_ID_INDEX:{{
    uint64_t v;
    cbor_value_get_uint64(&mapIt, &(v));
    msg->req_id = v;
};
...
Result<Bytes> HeatingRequest::cbor_serialize(const HeatingRequest& msg)  {
    ...
    if (msg.req_id) {
            RC_OK(cbor_encode_int(&mapEncoder, HeatingRequest::Field::REQ_ID_INDEX));
            RC_OK(cbor_encode_int(&mapEncoder, msg.req_id.value()));
            }
            // field: req_id
    if (msg.setpoint_c) {
 ...
 Result<HeatingRequest*> HeatingRequest::cbor_deserialize(const Bytes& bytes) {
    ...
    while (!cbor_value_at_end(&mapIt)) {
        ...
        switch (key) {
            ...
            case HeatingRequest::Field::REQ_ID_INDEX:{{
    uint64_t v;
    cbor_value_get_uint64(&mapIt, &(v));
    msg->req_id = v;
};
